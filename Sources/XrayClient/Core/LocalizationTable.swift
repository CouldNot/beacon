...
extension Loc {
    ...
    static let table: [String: [String: String]] = [
        ...
        "Paste one or more server links, one per line, or import from a QR code. Supports VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS, and WireGuard.": [
            "ru": "Вставьте одну или несколько ссылок на серверы, по одной на строку, или импортируйте QR-код. Поддерживаются VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS и WireGuard.",
            "zh": "粘贴一个或多个服务器链接，每行一个，或通过二维码导入。支持 VLESS、VMess、Trojan、Shadowsocks、Hysteria2、TUIC、AnyTLS 和 WireGuard。",
            "es": "Pega uno o más enlaces de servidor, uno por línea, o impórtalos desde un código QR. Compatible con VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS y WireGuard.",
            "hi": "एक या अधिक सर्वर लिंक पेस्ट करें, प्रति पंक्ति एक, या QR कोड से आयात करें। VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS और WireGuard समर्थित हैं।",
            "ar": "ألصق رابطًا واحدًا أو أكثر للخوادم، رابط واحد في كل سطر، أو استورد من رمز QR. يدعم VLESS و VMess و Trojan و Shadowsocks و Hysteria2 و TUIC و AnyTLS و WireGuard.",
            "fr": "Collez un ou plusieurs liens de serveur, un par ligne, ou importez depuis un code QR. Compatible avec VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS et WireGuard.",
            "pt": "Cole um ou mais links de servidor, um por linha, ou importe de um código QR. Compatível com VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS e WireGuard.",
            "de": "Füge einen oder mehrere Server-Links ein, einen pro Zeile, oder importiere per QR-Code. Unterstützt VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS und WireGuard.",
            "ja": "サーバーリンクを1行に1つずつ貼り付けるか、QRコードから読み込みます。VLESS、VMess、Trojan、Shadowsocks、Hysteria2、TUIC、AnyTLS、WireGuardに対応しています。",
            "id": "Tempel satu atau beberapa tautan server, satu per baris, atau impor dari kode QR. Mendukung VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS, dan WireGuard.",
            "tr": "Bir veya daha fazla sunucu bağlantısını her satıra bir tane olacak şekilde yapıştırın veya QR koddan içe aktarın. VLESS, VMess, Trojan, Shadowsocks, Hysteria2, TUIC, AnyTLS ve WireGuard desteklenir."],
